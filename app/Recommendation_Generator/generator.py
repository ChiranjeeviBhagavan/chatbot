...
class recommendationGenerator :
    ...
    def load_data(self,datapath):
        ...
        features = utils.reduce_mem_usage(pd.read_csv(datapath, usecols = ['click_courseware','load_video','pause_video','problem_check','problem_get','seek_video','stop_video','experience']))
